...
from cores.core_functions import login_to_hub, get_username, upload_models,list_models,remove_models
...
def main():
 ...
 /_/    \_\__|_|\__,_|___/ |____/|_|\___/|_|_| |_|_| \___/
    ...
    upload_parser.add_argument('model_path', type=str, help='Path to the local model')
    upload_parser.add_argument('-n', type=str, help='Repository name for upload (format: username/repo_name). Default is the model folder name', default=None)
    upload_parser.add_argument('-p', type=bool, help='Make model public (default: False)', default=False)
    ...
    if args.command == 'init':
        ...
        if args.command == 'upload':
            upload_models(args.model_path, username, args.n, args.p)
        elif args.command == 'list':
            list_models(args.f, username)
        elif args.command == 'remove':
            remove_models(args.repo_name, args.f)
        ...
        #     check_dataset(args.repo_name)
            ...
            parser.print_help()
        # except:
        #     logging.error("Please login first by running 'atlas_hfmodels init'")
        #     sys.exit(1)
